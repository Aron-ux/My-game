...
const ROLE_INTRO_CONTENT := {
	...
	"mage": {
		"name": "法师",
		"trait": "特性：法师每击杀一个怪物都有15％概率获得1层【奥数充能】。每层提供2％法师自身大招回能效率，并将法师自身获得的大招能量的10％同步给另外两名角色。",
		"buff": "状态：【奥法盈余】持续5秒，全员大招回能效率+20％，切人回能效率+20％，伤害+10％。法师释放登场技与大招时进入该状态；若状态自然结束时当前站场角色仍为法师，则额外获得3层【奥数充能】。",
...
const ROLE_INTRO_CONTENT_OVERRIDE := {
	...
	"mage": {
		"name": "法师",
		"trait": "特性：法师每击杀一个怪物都有15％概率获得1层[奥数充能]。每层提供2％法师自身大招回能效率，并将法师自身获得的大招能量的10％同步给另外两名角色。",
		"buff": "[奥法盈余]：持续5秒，全员大招回能效率+20％，切人回能效率+20％，伤害+10％。法师释放登场技与大招时进入该状态；若状态自然结束时当前站场角色仍为法师，则额外获得3层[奥数充能]。\n\n[奥数充能]：最多10层，每层提供2％法师自身大招回能效率，并将法师自身获得的大招能量的10％同步给另外两名角色。",
		"entry": "登场技：[密集雷群]。以法师自身为中心向5个方向释放雷击，每次造成100％伤害，并进入[奥法盈余]。\n\n大招：[奥数轰炸]。保留原有视觉效果与伤害轮次，移除旧的附加效果与击杀回能效果。"
	}
}

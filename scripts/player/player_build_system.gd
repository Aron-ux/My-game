...
const BUILD_DEFINITIONS := {
	"swordsman": [
		{"id": "trait_extra_roll", "title": "战意触发次数+1", "summary": "战意触发次数+1", "card_title": "剑士特性"},
		{"id": "trait_heal_bonus", "title": "战意触发时回复效果增加1％", "summary": "战意触发时回复效果增加1％", "card_title": "剑士特性"},
		{"id": "knight_glory_duration", "title": "骑士荣耀持续时间增加0.2s", "summary": "骑士荣耀持续时间增加0.2s", "card_title": "剑士特性"},
		{"id": "entry_damage", "title": "冲锋伤害倍率增加10％", "summary": "冲锋伤害倍率增加10％", "card_title": "冲锋"},
		{"id": "basic_attack_cooldown", "title": "剑士普通攻击冷却减少10％", "summary": "剑士普通攻击冷却减少10％", "card_title": "普通攻击"},
		{"id": "basic_attack_damage", "title": "剑士普通攻击伤害倍率增加10％", "summary": "剑士普通攻击伤害倍率增加10％", "card_title": "普通攻击"},
		{"id": "basic_attack_range", "title": "剑士普通攻击范围增加10％", "summary": "剑士普通攻击范围增加10％", "card_title": "普通攻击"},
		{"id": "blade_storm_damage", "title": "剑士剑刃风暴伤害倍率增加1.5％", "summary": "剑士剑刃风暴伤害倍率增加1.5％", "requires_skill": "blade_storm"},
		{"id": "blade_storm_area", "title": "剑刃风暴范围增加10％", "summary": "剑刃风暴范围增加10％", "requires_skill": "blade_storm"},
		{"id": "blade_storm_cooldown", "title": "剑刃风暴冷却时间减少5％", "summary": "剑刃风暴冷却时间减少5％", "requires_skill": "blade_storm"},
		{"id": "crescent_wave_cooldown", "title": "月牙剑气冷却时间减少10％", "summary": "月牙剑气冷却时间减少10％", "requires_skill": "crescent_wave"},
		{"id": "crescent_wave_damage", "title": "月牙剑气伤害倍率增加10％", "summary": "月牙剑气伤害倍率增加10％", "requires_skill": "crescent_wave"},
		{"id": "crescent_wave_speed", "title": "月牙剑气飞行速度增加20", "summary": "月牙剑气飞行速度增加20", "requires_skill": "crescent_wave"},
		{"id": "ultimate_damage", "title": "无敌斩伤害倍率+5％", "summary": "无敌斩伤害倍率+5％", "card_title": "无敌斩"},
		{"id": "unlock_blade_storm", "title": "获得技能：剑刃风暴", "summary": "获得技能：剑刃风暴", "unlock_skill": "blade_storm"},
		{"id": "unlock_crescent_wave", "title": "获得技能：月牙剑气", "summary": "获得技能：月牙剑气", "unlock_skill": "crescent_wave"}
	],
	"gunner": [
		{"id": "hunt_safe_radius", "title": "猎杀半径安全圈减少10", "summary": "猎杀半径安全圈减少10", "card_title": "枪手特性"},
		{"id": "hunt_inside_damage", "title": "枪手伤害对猎杀圈内敌人增加15％", "summary": "枪手伤害对猎杀圈内敌人增加15％", "card_title": "枪手特性"},
		{"id": "hunt_outside_damage", "title": "枪手伤害对猎杀圈外敌人增加5％", "summary": "枪手伤害对猎杀圈外敌人增加5％", "card_title": "枪手特性"},
		{"id": "flash_stack_bonus", "title": "瞬杀每层提供伤害+0.5％，移速+0.5％，闪避值+20", "summary": "瞬杀每层提供伤害+0.5％，移速+0.5％，闪避值+20", "card_title": "枪手特性"},
		{"id": "entry_damage", "title": "枪火典礼伤害倍率+10％", "summary": "枪火典礼伤害倍率+10％", "card_title": "枪火典礼"},
		{"id": "basic_attack_damage", "title": "枪手普通攻击伤害倍率+10％", "summary": "枪手普通攻击伤害倍率+10％", "card_title": "普通攻击"},
		{"id": "basic_attack_cooldown", "title": "枪手普通攻击冷却时间减少5％", "summary": "枪手普通攻击冷却时间减少5％", "card_title": "普通攻击"},
		{"id": "basic_attack_range", "title": "枪手普通攻击距离+10", "summary": "枪手普通攻击距离+10", "card_title": "普通攻击"},
		{"id": "shrapnel_cooldown", "title": "散弹冷却时间-10％", "summary": "散弹冷却时间-10％", "requires_skill": "shrapnel_field"},
		{"id": "shrapnel_damage", "title": "散弹伤害倍率+2％", "summary": "散弹伤害倍率+2％", "requires_skill": "shrapnel_field"},
		{"id": "shrapnel_radius", "title": "散弹范围半径+10", "summary": "散弹范围半径+10", "requires_skill": "shrapnel_field"},
		{"id": "infinite_reload_speed", "title": "无限装填期间移速+1％", "summary": "无限装填期间移速+1％", "requires_skill": "infinite_reload"},
		{"id": "infinite_reload_damage", "title": "无限装填伤害倍率+1％", "summary": "无限装填伤害倍率+1％", "requires_skill": "infinite_reload"},
		{"id": "infinite_reload_range", "title": "无限装填攻击距离增加10", "summary": "无限装填攻击距离增加10", "requires_skill": "infinite_reload"},
		{"id": "infinite_reload_cooldown", "title": "无限装填CD-10％", "summary": "无限装填CD-10％", "requires_skill": "infinite_reload"},
		{"id": "ultimate_wave_count", "title": "火箭弹幕波次+2", "summary": "火箭弹幕波次+2", "card_title": "火箭弹幕"},
		{"id": "unlock_shrapnel_field", "title": "获得技能：散弹", "summary": "获得技能：散弹", "unlock_skill": "shrapnel_field"},
		{"id": "unlock_infinite_reload", "title": "获得技能：无限装填", "summary": "获得技能：无限装填", "unlock_skill": "infinite_reload"}
	],
	"mage": [
		{"id": "arcane_surplus_duration", "title": "奥法盈余持续时间+1", "summary": "奥法盈余持续时间+1", "card_title": "法师特性"},
		{"id": "arcane_charge_chance", "title": "奥数充能获取概率+2％", "summary": "奥数充能获取概率+2％", "card_title": "法师特性"},
		{"id": "arcane_charge_energy", "title": "奥数充能每层提供的大招回能效率+1％", "summary": "奥数充能每层提供的大招回能效率+1％", "card_title": "法师特性"},
		{"id": "arcane_charge_share", "title": "奥数充能每层提供的大招能量同步增加5％", "summary": "奥数充能每层提供的大招能量同步增加5％", "card_title": "法师特性"},
		{"id": "basic_attack_damage", "title": "法师普通攻击伤害倍率+15％", "summary": "法师普通攻击伤害倍率+15％", "card_title": "普通攻击"},
		{"id": "basic_attack_range", "title": "法师普通攻击范围增加5％", "summary": "法师普通攻击范围增加5％", "card_title": "普通攻击"},
		{"id": "meta_field_slow", "title": "梅塔领域造成的减速+5％", "summary": "梅塔领域造成的减速+5％", "requires_skill": "meta_field"},
		{"id": "meta_field_reduction_value", "title": "梅塔领域提供的减伤值+10", "summary": "梅塔领域提供的减伤值+10", "requires_skill": "meta_field"},
		{"id": "meta_field_radius", "title": "梅塔领域范围+5％", "summary": "梅塔领域范围+5％", "requires_skill": "meta_field"},
		{"id": "meta_field_damage", "title": "梅塔领域伤害倍率+2％", "summary": "梅塔领域伤害倍率+2％", "requires_skill": "meta_field"},
		{"id": "surging_wave_cooldown", "title": "波涛汹涌冷却时间-10％", "summary": "波涛汹涌冷却时间-10％", "requires_skill": "surging_wave"},
		{"id": "surging_wave_damage", "title": "波涛汹涌伤害倍率+10％", "summary": "波涛汹涌伤害倍率+10％", "requires_skill": "surging_wave"},
		{"id": "surging_wave_duration", "title": "波涛汹涌持续时+0.5s", "summary": "波涛汹涌持续时+0.5s", "requires_skill": "surging_wave"},
		{"id": "surging_wave_speed", "title": "波涛汹涌移动速度+5", "summary": "波涛汹涌移动速度+5", "requires_skill": "surging_wave"},
		{"id": "ultimate_bombard_count", "title": "奥数轰炸次数+2", "summary": "奥数轰炸次数+2", "card_title": "奥数轰炸"},
		{"id": "unlock_meta_field", "title": "获得技能：梅塔领域", "summary": "获得技能：梅塔领域", "unlock_skill": "meta_field"},
		{"id": "unlock_surging_wave", "title": "获得技能：波涛汹涌", "summary": "获得技能：波涛汹涌", "unlock_skill": "surging_wave"}
	]
}

...
const TALENT_DEFINITIONS := {
	"swordsman_trait": [
		{"id": "swordsman_trait_blood_battle", "title": "血战昂扬", "description": "战意实际治疗后，3秒内剑士总伤害提高15%；刷新持续时间，不叠层。"},
		{"id": "swordsman_trait_last_guard", "title": "最后的换防", "description": "剑士在后台时，可消耗满换位能量与骑士荣耀挽救一次前台角色，并强制剑士登场；80秒冷却。"}
	],
	"swordsman_entry": [
		{"id": "swordsman_entry_long_charge", "title": "长驱冲阵", "description": "首次冲锋命中后再向前突进120距离，造成70%伤害。"},
		{"id": "swordsman_entry_return_guard", "title": "回马护阵", "description": "首次冲锋后沿原路返回起点，造成70%伤害。"}
	],
	"swordsman_basic": [
		{"id": "swordsman_basic_cross", "title": "十字剑势", "description": "每第3次普通攻击追加一道垂直剑气，造成70%伤害。"},
		{"id": "swordsman_basic_back", "title": "背身斩", "description": "普通攻击主斩同时向身后追加一次45%伤害斩击。"}
	],
	"swordsman_blade_storm": [
		{"id": "swordsman_blade_storm_retain", "title": "随身风暴", "description": "切换角色后，剑刃风暴跟随当前角色完成剩余持续时间，伤害降为70%。"},
		{"id": "swordsman_blade_storm_stationary", "title": "驻地风暴", "description": "剑刃风暴固定在施放地点，命中使敌人短暂减速至70%。"}
	],
	"swordsman_crescent_wave": [
		{"id": "swordsman_crescent_return", "title": "月返", "description": "月牙剑气抵达终点后返回一次，返回伤害为60%。"},
		{"id": "swordsman_crescent_full_moon", "title": "满月重刃", "description": "剑气变短、变宽、变慢，形成更稳定的近中距离横扫。"}
	],
	"swordsman_ultimate": [
		{"id": "swordsman_ultimate_king", "title": "擒王", "description": "存在Boss时，无敌斩优先追击最近Boss，线斩伤害提高30%。"},
		{"id": "swordsman_ultimate_blossom", "title": "剑华", "description": "每次线斩终点产生一次半径70、伤害为线斩30%的爆发。"}
	],
	"gunner_trait": [
		{"id": "gunner_trait_clear_hunt", "title": "清场猎手", "description": "猎杀圈内无敌人时，每1.25秒获得瞬杀层数；敌人进入时暂停积累。"},
		{"id": "gunner_trait_invade_hunt", "title": "侵入猎场", "description": "猎杀圈内有敌人时，每1.25秒获得瞬杀层数，圈内伤害加成提高至75%。"}
	],
	"gunner_entry": [
		{"id": "gunner_entry_focus", "title": "聚焦礼炮", "description": "登场技改为3波五发前向扇射，每发造成原伤害35%。"},
		{"id": "gunner_entry_denial", "title": "封锁礼炮", "description": "登场技改为2波十二发环射，每发50%伤害并造成40%减速1.5秒。"}
	],
	"gunner_basic": [
		{"id": "gunner_basic_armor", "title": "破甲重弹", "description": "每第4次普通攻击发射2倍伤害、更大且高穿透的重弹。"},
		{"id": "gunner_basic_burst", "title": "三连点射", "description": "每次普通攻击改为3发短点射，每发42%伤害。"}
	],
	"gunner_shrapnel": [
		{"id": "gunner_shrapnel_mobile", "title": "机动弹幕", "description": "两处固定散弹场合并为跟随枪手的单一弹幕场，范围与伤害提高。"},
		{"id": "gunner_shrapnel_delayed", "title": "延迟引爆", "description": "基础散弹场自然结束时爆炸，造成当前每跳伤害的250%并续接减速。"}
	],
	"gunner_infinite_reload": [
		{"id": "gunner_infinite_axis", "title": "轴线贯穿", "description": "无限装填锁定初始方向，射程更长、光束更窄且每跳伤害提高55%。"},
		{"id": "gunner_infinite_dual", "title": "双轨齐射", "description": "无限装填变为两条平行光束，每条造成60%伤害。"}
	],
	"gunner_ultimate": [
		{"id": "gunner_ultimate_line", "title": "线列轰炸", "description": "火箭弹幕收窄并延长，每波伤害提高55%。"},
		{"id": "gunner_ultimate_fan", "title": "广域覆盖", "description": "火箭弹幕大幅扩展角度、缩短射程，每波伤害降至70%。"}
	],
	"mage_trait": [
		{"id": "mage_trait_relay", "title": "奥能接力", "description": "奥数充能转移后可在两名非法师角色间额外接力一次。"},
		{"id": "mage_trait_ultimate", "title": "奥能终式", "description": "充能持有者施放终结技时，每层使最终伤害提高2%，最高20%，随后清空。"}
	],
	"mage_entry": [
		{"id": "mage_entry_center", "title": "雷环归心", "description": "五道环形落雷后，中心追加一次150%范围、60%伤害的落雷。"},
		{"id": "mage_entry_mark", "title": "雷印点名", "description": "登场落雷优先命中范围内至多5个不同敌人，剩余次数补回雷环。"}
	],
	"mage_basic": [
		{"id": "mage_basic_aftershock", "title": "奥术余震", "description": "主爆炸0.35秒后在原处追加一次45%伤害余震。"},
		{"id": "mage_basic_triangle", "title": "三角术式", "description": "主爆炸分裂为三角形三点，每点范围70%、伤害40%。"}
	],
	"mage_meta_field": [
		{"id": "mage_meta_transfer", "title": "领域转移", "description": "切换角色后领域跟随下一角色4秒，范围、伤害和减速衰减且不再减伤。"},
		{"id": "mage_meta_collapse", "title": "领域坍缩", "description": "切换角色时立即结束领域并爆发2倍当前每跳伤害，随后进入8秒冷却。"}
	],
	"mage_surging_wave": [
		{"id": "mage_surge_four", "title": "四向潮涌", "description": "基础波次向四个正交方向发射，每道造成55%伤害。"},
		{"id": "mage_surge_back", "title": "逆潮回响", "description": "基础前向波0.8秒后从当前角色位置反向追加70%伤害波。"}
	],
	"mage_ultimate": [
		{"id": "mage_ultimate_lock", "title": "星落锁定", "description": "锁定Boss或单一敌人追踪轰炸，范围缩小、伤害提高25%。"},
		{"id": "mage_ultimate_triangle", "title": "三星阵列", "description": "锁定敌群中心周围三处节点，轰炸依次循环落于节点。"}
	]
}
...
static func _build_offer_for_choice(owner, pending: Dictionary) -> Dictionary:
	...
	return {
		...
		"context": {
			...
			"role_id": role_id,
			"skill_progress_id": progress_id,
			"summary": "技能构筑达到 Lv.%d：选择一项质变。" % TRIGGER_LEVEL
		}
	}
...
static func _get_talent_title(progress_id: String, talent_id: String) -> String:
	for definition_value in TALENT_DEFINITIONS.get(progress_id, []):
		if definition_value is Dictionary and str((definition_value as Dictionary).get("id", "")) == talent_id:
			return str((definition_value as Dictionary).get("title", talent_id))
	return talent_id

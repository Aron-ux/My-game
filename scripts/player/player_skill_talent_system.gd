...
const LEVEL_TALENT_DEFINITIONS := {
	"swordsman": [
		...
		{"id": "swordsman_level_talent_king_blade_1", "title": "剑士天赋·王者之剑 I", "summary": "王者之剑变为连续 3 道斩击，每道间隔 0.8 秒，每道造成 400% 伤害。冷却时间增加 8 秒。", "level_talent_group_id": "swordsman_king_blade_variant"},
		{"id": "swordsman_level_talent_king_blade_2", "title": "剑士天赋·王者之剑 II", "summary": "每次击杀永久增加剑士最大生命值 0.05 点。", "level_talent_group_id": "swordsman_king_blade_variant"},
